  ...
  >
    ...
    >
      ...
      >
        ...
        /></slot>
        <div
          v-html="typeof content === 'function' ? content(engine) : content"
        ></div>
      </a>
    </a-tooltip>
  </div>
...
import { formatHotkey, isMobile } from "@/aomao/engine/src";
...
export default defineComponent({
  ...
  methods: {
    triggerSelect(event: MouseEvent, key: string) {
      ...
      if (this.onSelect && this.onSelect(event, key, this.engine) === false)
        return;
